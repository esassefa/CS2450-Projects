 ...
 */
public class HangmanFOld extends javax.swing.JFrame {

    /** Creates new form HangmanFOld */
   ...
   // String choice = words[rand];
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HangmanFOld.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HangmanFOld().setVisible(true);
            }
        });
    }
